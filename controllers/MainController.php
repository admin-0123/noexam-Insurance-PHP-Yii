	...
	*/
	...
	public function actionPost(){
		...
		if($request->isPost){
			...
			$model = $this->getCustomeData(['create', 'new'], $request_post, false);
			...
			#VarDumper::dump($request->post('CustomerData')); exit;
			...
			switch($request->post('CustomerData')['form_name']){
				...
				case 'homeform':
					...
					break;
				case 'applyrate':
					// var_dump("Apply Rate");exit;
					$scenario     = CustomerData::SCENARIO_APPLY_RATE;
					$status       = "create";
					$iniciator    = "apply-rate";
					$redirect_url = $request->post('CustomerData')['redirect'];
					break;
				case 'contentform':
