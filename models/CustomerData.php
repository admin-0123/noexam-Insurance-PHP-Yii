...
class CustomerData extends ActiveRecord
{
	...
	const SCENARIO_APPLY_RATE = 'apply-rate';
	...
	public function scenarios()
	{
		...
		$scenarios[self::SCENARIO_APPLY_RATE] = ['term_length', 'avg_amount', 'state', 'tobaco', 'age', 'first_name', 'last_name', 'email', 'phone_number'];
	...
	public function rules()
	{
		return [
			...
			// 	'threshold' => 0.3,
			// 	'secret' => '6Lf3Fd4ZAAAAAGvAOfcWe03NhyJ6vWL9qTPGwUwy', // unnecessary if reСaptcha is already configured
			// 	#'action' => 'post',
			// ],
			// ['reCaptcha', \himiklab\yii2\recaptcha\ReCaptchaValidator::class, 'secret' => '6Lf3Fd4ZAAAAAGvAOfcWe03NhyJ6vWL9qTPGwUwy']
			[['reCaptcha'], \himiklab\yii2\recaptcha\ReCaptchaValidator3::class,
        'secret' => '6LeVpNsZAAAAAILW_qz0qwFs4k48iA1-_ps2X8Ri', // unnecessary if reСaptcha is already configured
        'threshold' => 0.5,
        'action' => 'homepage',
      ],
		];
