...
<div class="main-wrapp bg1">
                <div class="wrapp">
                    <?=GetQuote::widget(['title' => 'Check Rates at Haven Life', 'subtitle' => 'Up to $1,000,000 of Coverage Without a Medical Exam. Apply in Minutes.', 'button_link' => '/out/haven-rates.php']);?>
                </div>
            </div>
