		...
		<section class="get-started">
			...
			<div class="d-flex justify-content-center align-items-center">
				...
				<div class="fs-advice__col" data-toggle="popover">
					<a class="get-started__link" role="button" tabindex="-1" data-content="NoExam.com may receive compensation when visitors click on and/or apply to life insurance offers featured on NoExam.com.">Advertiser Disclosure
					</a>
				</div>
			</div>
		</section>
			...
			<div id="sorting_list" class="top-companies-v2__body position-relative">
				...
				<div class="item top-companies-v2__row" data-weight="1" data-peoples-count="95" data-company-name="Legal & General">
					<div class="top-companies-v2__card company-card-v2">
						...
						<div class="top-companies-v2-card__col">
							<a href="#contactFormModal" class="company-card__link button-small main-btn" data-toggle="modal">Get Rates</a>
							<!-- <a href="/out/quotes-2.php" class="company-card__link button-small main-btn" data-toggle="modal">Get Rates</a> -->
