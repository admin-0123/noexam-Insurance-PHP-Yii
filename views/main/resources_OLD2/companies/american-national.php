...
<div class="page-content page-wrapper trans_all">
	...
	<section class="page">
		...
		<div class="boxcontent">
			...
			<p><a href="#howmuch">How much can you get?</a><br />
			<a href="#howold">How old can you be?</a><br />
			<a href="#whatif">What if I have health issues?</a><br />
			<a href="#sampleamerican">Sample American National Rates</a><br />
			<a href="#whole-term">Is the plan whole life or term?<br />
			</a><a href="#isthere">Is there a waiting period?</a><a href="#whole-term"><br />
			</a><a href="#howlong">How long will the approval take?</a><a href="#whole-term"><br />
			</a><a href="#compare">Compare other options!</a><a href="#whole-term"><br />
			</a><a name="howmuch"></a></p>
			<p><iframe src="https://www.youtube.com/embed/1m1qzOUG9k4" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe></p>
			<h2>How Much Can you Get with American National Life Insurance?</h2>
			<p>ANICO offers a life insurance that does not require a medical exam. You can purchase term coverage between $50,000 to $250,000. You can obtain whole life up to $150,000.</p>
			<p>If you need more than $250,000 in coverage, consider some of these <a href="https://phpstack-223893-690316.cloudwaysapps.com/life-insurance/companies/">top life insurance companies</a>.</p>
			<p><a name="howold"></a></p>
			<h2>How old can you be for ANICO Life Insurance?</h2>
			<p>American National Life Insurance is available through age 65. For life insurance over 65 years old, please visit noexam.com. Please see this page for more information on <a href="https://phpstack-223893-690316.cloudwaysapps.com/">life insurance that does not require an exam</a>.<br />
			<a name="whatif"></a></p>
			...
			<p>In some cases, they will request a copy of your medical records. American National Life Insurance is a good fit for people with controlled high blood pressure, type 2 diabetes, weight loss and sleep apnea.<br />
			<a name="sampleamerican"></a></p>
			<h2>Sample American National Life Insurance Rates</h2>

			<table id="tablepress-60" class="tablepress tablepress-id-60">
			<thead>
			<tr class="row-1 odd">
				<th class="column-1">Gender</th><th class="column-2">Age</th><th class="column-3">Coverage Amount</th><th class="column-4">Term Length</th><th class="column-5">Monthly Premium</th>
			</tr>
			</thead>
			<tbody class="row-hover">
			<tr class="row-2 even">
				<td class="column-1">Male</td><td class="column-2">30</td><td class="column-3">$100,000</td><td class="column-4">20 Year</td><td class="column-5">$17.54</td>
			</tr>
			<tr class="row-3 odd">
				<td class="column-1">Female</td><td class="column-2">30</td><td class="column-3">$100,000</td><td class="column-4">20 Year</td><td class="column-5">$18.06</td>
			</tr>
			<tr class="row-4 even">
				<td class="column-1">Male</td><td class="column-2">40</td><td class="column-3">$100,000</td><td class="column-4">20 Year</td><td class="column-5">$29.81</td>
			</tr>
			<tr class="row-5 odd">
				<td class="column-1">Female</td><td class="column-2">40</td><td class="column-3">$100,000</td><td class="column-4">20 Year</td><td class="column-5">$25.40</td>
			</tr>
			<tr class="row-6 even">
				<td class="column-1">Male</td><td class="column-2">49</td><td class="column-3">$100,000</td><td class="column-4">20 Year</td><td class="column-5">$52.44</td>
			</tr>
			<tr class="row-7 odd">
				<td class="column-1">Female</td><td class="column-2">49</td><td class="column-3">$100,000</td><td class="column-4">20 Year</td><td class="column-5">$41.21</td>
			</tr>
			</tbody>
			</table>
			<!-- #tablepress-60 from cache -->
			<p><strong>Disclaimer:</strong> Rates are based on Standard, Non-Smoker as of 01/2017. Actual rates and availability may vary by state and health profile.<br />
			<a name="whole-term"></a></p>
			<h2>Is ANICO’s Plan Whole Life Or Term?</h2>
			<p>American National Life Insurance is available in whole life and term. Their term lengths offered are 10,20 and 30 years.<br />
			<a name="isthere"></a></p>
			<h2>Is There a Waiting Period?</h2>
			<p>If you apply for the plans that requires medical underwriting, you will not have a waiting period upon approval. American National also offers a guaranteed plan that has no medical questions; however, a waiting period applies.<br />
			<a name="howlong"></a></p>
			<h2>How Long Will the Approval Take?</h2>
			...
			<p>If you’d like coverage sooner and do not want any medical records ordered, consider choosing either <a href="https://phpstack-223893-690316.cloudwaysapps.com/life-insurance/companies/sagicor/">Sagicor Life Insurance</a> or North American. These two alternatives are reliable companies that offer competitive prices and a much faster turn around time. Your policy approval is anywhere from 15 minutes to 24-72hrs!<br />
			<a name="compare"></a></p>
			<h2>Comparisons Between These Three Life Insurance Options</h2>
			...
			<thead>
			<tr class="row-1 odd">
				<th class="column-1">Gender</th><th class="column-2">Age</th><th class="column-3">ANICO</th><th class="column-4">North American</th><th class="column-5">Sagicor</th>
			</tr>
			</thead>
			<tbody class="row-hover">
			<tr class="row-2 even">
				<td class="column-1">Male</td><td class="column-2">30</td><td class="column-3">$17.54</td><td class="column-4">$14.87</td><td class="column-5">$14.25</td>
			</tr>
			<tr class="row-3 odd">
				<td class="column-1">Female</td><td class="column-2">30</td><td class="column-3">$18.06</td><td class="column-4">$13.38</td><td class="column-5">$12.09</td>
			</tr>
			<tr class="row-4 even">
				<td class="column-1">Male</td><td class="column-2">40</td><td class="column-3">$29.81</td><td class="column-4">$19.27</td><td class="column-5">$21.64</td>
			</tr>
			<tr class="row-5 odd">
				<td class="column-1">Female</td><td class="column-2">40</td><td class="column-3">$25.40</td><td class="column-4">$16.28</td><td class="column-5">$18.28</td>
			</tr>
			<tr class="row-6 even">
				<td class="column-1">Male</td><td class="column-2">49</td><td class="column-3">$52.44</td><td class="column-4">$31.06</td><td class="column-5">$42.44</td>
			</tr>
			<tr class="row-7 odd">
				<td class="column-1">Female</td><td class="column-2">49</td><td class="column-3">$41.21</td><td class="column-4">$24.64</td><td class="column-5">$32.27</td>
			</tr>
			</tbody>
			</table>
			<!-- #tablepress-61 from cache -->
			<h2>Get In Touch</h2>
			<p>At <a href="https://phpstack-223893-690316.cloudwaysapps.com/">NoExam.com</a>, we value your time and promise to offer life insurance with no hassle! We want to help you get this taken care of so you can get back to spending time with the ones you love the most.Our licensed agents can help you find the best life insurance plan for your situation. <strong>Please call us at 888-407-0714.</strong></p>
