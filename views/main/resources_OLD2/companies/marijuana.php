...
<div class="page-content page-wrapper trans_all">
	...
	<section class="page">
      ...
      <h2>Can Marijuana Users Qualify for Life Insurance? </h2>
      ...
      <p>There are many marijuana users who do not apply for life insurance because they mistakenly believe that they might not qualify at all or they might be charged exorbitant rates, which they might not be able to afford. This is not true at all. </p>
			<ul>
			<li>First of all, marijuana use does not automatically disqualify you from getting life insurance. There are many insurance providers who accept marijuana users and issue policies for them. </li>
      ...
      <h2>How Does Marijuana Use Affect Your Insurability?</h2>
    ...
    <p>  Generally speaking, a medical marijuana card can help you qualify for non-smoker rates with most insurance companies, as long as you do not have any serious health problem. </p>
      ...
      <h2>Best Life Insurance Companies for Marijuana Users</h2>
...
<div class="company-box">
	<img style="float:right;" src="../../../img/metlife-logo.png" alt="metlife life insurance" />
      ...
      <p>MetLife does not generally test for THC. So, the rates are determined based on your admission of usage. The company’s underwriting policies with respect to marijuana use are very liberal when compared to most other companies in the industry today. It is why MetLife remains one of the preferred choices of avid marijuana users. </p>
			...
			<h2>How to Get the Best Rates as a Marijuana User</h2>

      <h3>Get Multiple Quotes</h3>

      <p>It goes without saying that you need to get customized quotes from multiple insurance providers before zeroing in on one. This is particularly important for marijuana users, as you are at a much higher risk of being classified as a high risk consumer compared to someone who does not use any kind of narcotics. </p>
