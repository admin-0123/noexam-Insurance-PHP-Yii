...
<div class="page-content page-wrapper trans_all">
	...
	<section class="page">
		...
		<div class="content">
      <p>Smoking is one of the risk factors that can affect your insurability to a considerable extent. Choosing the best life insurance company is important for a smoker, as rates can often be cheaper.</p>
      ...
      <h2>How Does Your Smoking Habit Affect Your Insurability? </h2>

      <p>Insurance companies decide the cost of a policy (the amount of premium you have to pay) based on your mortality risk and the probability of paying out the death benefit to your beneficiary. The higher the probability, the higher are the costs associated with the policy. </p>

      <p>Smoking is known to increase the risk of cardiovascular disease, respiratory disease, cancer, and a number of other ailments. </p>

      <p>It is also known to increase your overall mortality risk. Data from the CDC shows that the lifespan of the average smoker is likely to be 10 years shorter than the lifespan of a non-smoker. </p>
      ...
      <h2>Factors Considered by Insurance Providers While Rating Smokers</h2>
...
<ul>
      ...
      <h2>How Do Insurance Companies Test for Tobacco/Nicotine Use? </h2>
    ...
    <ul>
      ...
      <h2>What Risk Class Are You Likely to Be Assigned as a Smoker?</h2>
      <ul>
...
<ul>
      ...
      <h2>Average Life Insurance Rates for Smokers and Non-Smokers</h2>

      <p>Given below is the average cost of a 20-year term life policy with a death benefit of $250,000 for smokers and non-smokers. </p>
      ...
      Age	Monthly Premium (For Non-Smokers)	Monthly Premium (For Smokers)
      ...
      <p>Now, let us take a look at five insurance companies which offer the most reasonably priced policies for smokers. </p>

      <h2>Top Five Life Insurance Companies for Smokers</h2>
...
<ul>
      ...
      <p>No matter what type of life insurance policy you are looking for, AIG is one of the best options available for you, thanks to its exceptionally wide range of products. </p>
      ...
      <p>AIG is notorious for its slow-paced approval process, which can take anywhere from 4 to 12 weeks. However, if you are a smoker, it is a small price to pay compared to how much you stand to save by buying an affordably priced policy.</p>
</div>
<div class="company-box">
...
<ul>
      ...
      <p>Prudential is yet another insurance company that many smokers swear by, as the policy costs are comparatively cheaper. What makes the company stand out from its competitors – even among those with lenient underwriting guidelines – is the fact that it issues non-tobacco rates for people who smoke cigars. </p>
...
<ul>
      ...
      <p>Transamerica offers you a wide range of term life and permanent life policies to choose from and the rates are among the lowest, even for active smokers. The company also allows you to qualify for certain policies without undergoing a medical exam. </p>
      ...
      <h2>How to Acquire Favorable Rates as a Smoker? </h2>
