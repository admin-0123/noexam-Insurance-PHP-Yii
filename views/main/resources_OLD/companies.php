...
<div class="page-content page-wrapper trans_all">
	...
	<section class="page">
		...
		<p>Finding the best life insurance for your situation is important. Life insurance, by definition, comes into effect only when you are gone.</p>
		<div class="company-box">
		<h5 style="text-align: center;"><strong>Healthy as a horse? <a href="http://www.avantlink.com/click.php?tt=ml&amp;ti=645437&amp;pw=239041">Get a quote with Health IQ</a> and you can save up to 20% on life insurance.</strong></h5>
		</div>
	...
	<p><u>Strengths</u>: Fast coverage and flexible policies.
		...
		<caption style="caption-side:bottom;text-align:left;border:none;background:none;margin:0;padding:0;"><a href="https://phpstack-223893-690316.cloudwaysapps.com/wp-admin/admin.php?page=tablepress&action=edit&table_id=88">Edit</a></caption>
		<thead>
		<tr class="row-1 odd">
			<th class="column-1">Company</th><th class="column-2">JD Power</th><th class="column-3">BBB</th><th class="column-4">AM Best</th><th class="column-5">Moody's</th><th class="column-6">Fitch</th><th class="column-7">Standard &amp; Poor's</th><th class="column-8">Comdex</th>
		</tr>
		</thead>
		<tbody class="row-hover">
		<tr class="row-2 even">
			<td class="column-1">AIG</td><td class="column-2">741</td><td class="column-3">A+</td><td class="column-4">A</td><td class="column-5">A2</td><td class="column-6">A+</td><td class="column-7">A+</td><td class="column-8">81</td>
		</tr>
		<tr class="row-3 odd">
			<td class="column-1">Assurity</td><td class="column-2">N/A</td><td class="column-3">A+</td><td class="column-4">A-</td><td class="column-5">N/A</td><td class="column-6">N/A</td><td class="column-7">N/A</td><td class="column-8">N/A</td>
		</tr>
		<tr class="row-4 even">
			<td class="column-1">Banner</td><td class="column-2">N/A</td><td class="column-3">A+</td><td class="column-4">A+</td><td class="column-5">N/A</td><td class="column-6">AA-</td><td class="column-7">AA-</td><td class="column-8">94</td>
		</tr>
		<tr class="row-5 odd">
			<td class="column-1">Mutual of Omaha</td><td class="column-2">792</td><td class="column-3">A+</td><td class="column-4">A+</td><td class="column-5">A1</td><td class="column-6">N/A</td><td class="column-7">AA-</td><td class="column-8">93</td>
		</tr>
		<tr class="row-6 even">
			<td class="column-1">North American</td><td class="column-2">N/A</td><td class="column-3">A+</td><td class="column-4">A+</td><td class="column-5">N/A</td><td class="column-6">A+</td><td class="column-7">A+</td><td class="column-8">93</td>
		</tr>
		<tr class="row-7 odd">
			<td class="column-1">Protective</td><td class="column-2">N/A</td><td class="column-3">A+</td><td class="column-4">A+</td><td class="column-5">A</td><td class="column-6">A+</td><td class="column-7">AA-</td><td class="column-8">N/A</td>
		</tr>
		<tr class="row-8 even">
			<td class="column-1">Prudential</td><td class="column-2">N/A</td><td class="column-3">A+</td><td class="column-4">A+</td><td class="column-5">A1</td><td class="column-6">AA-</td><td class="column-7">AA-</td><td class="column-8">92</td>
		</tr>
		<tr class="row-9 odd">
			<td class="column-1">SBLI</td><td class="column-2">N/A</td><td class="column-3">A+</td><td class="column-4">A</td><td class="column-5">N/A</td><td class="column-6">N/A</td><td class="column-7">A-</td><td class="column-8">84</td>
		</tr>
		<tr class="row-10 even">
			<td class="column-1">Metlife</td><td class="column-2">793</td><td class="column-3">C-</td><td class="column-4">A+</td><td class="column-5">A1</td><td class="column-6">AA-</td><td class="column-7">AA-</td><td class="column-8">95</td>
		</tr>
		</tbody>
		</table>
