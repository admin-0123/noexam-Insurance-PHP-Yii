...
<div class="page-content page-wrapper trans_all">
	...
	<section class="page">
		...
		<div class="content">
			<p>A life insurance policy that offers coverage for a fixed duration is known as: term life insurance.</p>
			...
			<p>The insured is required to pay a pre-determined amount as premium at periodic intervals during the
				...
				at the new rates and conditions prevailing at that time.</p>

			<p>If the policyholder passes away before the maturity date, the insurance company will pay death
				benefits, as promised in the term life policy to his or her nominee.</p>
			...
			<p>The main purpose of this type of policy is to protect your loved ones from large financial
				burdens due to your sudden death. Analyze for how many years you expect your family to be
			...
			<p>To calculate the right death benefit amount you need to make a tradeoff between two important considerations:</p>
			...
			<h2>Who Should Choose Term Life Insurance?</h2>

			<p>In general, the term life insurance is a sound policy option for anyone. But some
			...
			<p>If the family’s main earning member passes away before the children grow up or the mortgage has been paid, the family may have to endure
			...
			<h2>Length of Term Insurance Policy</h2>
			...
			<h2>Supporting Parents or Elderly Relatives</h2>
			...
			<h2>Factors that could Influence Your Premium</h2>
			...
			<h2>Term Life Insurance Riders</h2>
			...
			<h2>How much term insurance do you need?</h2>
			...
			<h2>Term Life Insurance Claim and Taxation</h2>
			...
			<h2>Term Life Insurance Beneficiary</h2>
