...
<div class="applynow-form-section rate-calc widget <?=$position;?> <?=$container_class;?> trans_all" style="<?=$width;?>">
	...
	<div class="<?=$row_class;?>">
		...
		<div class="<?=$col_1_class;?>">
			<div class="form-wrap">
				<?php $form = ActiveForm::begin(['id' => 'rate-calc-form', 'action' => '/post-rate-calc-simple/', 'enableAjaxValidation' => false, 'validationUrl' => '/validate-rate-calc/', 'options' => ['class' => 'applynow-form', 'data-autoload' => $autoload],'fieldConfig' => ['options' => ['tag' => false]]]);?>
