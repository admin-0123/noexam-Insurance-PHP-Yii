...
class BaseController extends Controller{
	...
	public function getCustomeData($status = null, $data = null, $reset = false){
		$customer_data = null;
		$session       = Yii::$app->session;
		...
		// Check the customer already exist
		$customer_data = CustomerData::find()
				->where("data LIKE :email")
				->params([':email' => '%"email":"' . $data['CustomerData']['email'] . '"%'])
				->one();
