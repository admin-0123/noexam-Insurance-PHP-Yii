...
// jQuery code to format the phone number input progressively
$(document).ready(function() {

  // Function to format the phone number progressively
  ...
  // Event listener to update the input value when changed
  $('.phone-input').on('input', function() {
    let inputVal = $(this).val().substring(0, 14); // Limit input to 10 digits
    const formattedNumber = formatPhoneNumber(inputVal);
